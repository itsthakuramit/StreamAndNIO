...
public class StreamOperationsExercise {
	...
	static Player p1= new Player("Virat Kohli", 30, 11000, 110, new Country("IND", "India"));
	...
	static Player p4= new Player("Shikhar Dhawan", 30, 6000, 120, new Country("IND", "India"));
	...
	public static void getPlayerNamesSorted() {
		//playerList.stream()
		//.sorted(Comparator.comparing().thenComparing(Player::getMatchesPlayed));
	}
